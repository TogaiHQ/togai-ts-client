...
export interface MetricQuery {
    ...
    /**
     * Group your metric with a groupBy field.  Allowed fields are  ACCOUNT_ID EVENT_STATUS  SCHEMA_NAME  USAGE_METER_ID  RAW_EVENT_STATUS Please refer the table above for the list of combinations allowed in the groupBy 
     * @type {string}
     * @memberof MetricQuery
     */
    'groupBy'?: string;
